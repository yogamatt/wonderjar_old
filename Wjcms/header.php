...
<body class="<?php wj_body_classes(); ?>">
	<header class="main-header" id="top" role="header">
		<div class="inner-container">
			<div class="header-container">
				<div class="logo-container">
					<a href="/" class="logo-link">
						<img src="/images/logo/wjmagicwand.png" alt="wjlogo" class="logo">
					</a>
				</div>
				<div class="navigation-container">
					<!-- Header-menu admin-->
					<?php include ($_SERVER['DOCUMENT_ROOT'].'/templates/template-parts/header/menu.php'); ?>
